...
<link rel="stylesheet" href="./css/sawonUpdateForm.css">
</head>
<body>
...
<table>
<tr class="mem"><td>이름</td><td>이메일</td><td>전화번호</td><td>비밀번호</td></tr>
<tr class="list"><td><input type="text" value="${stv.name}" name="name"></td>
...
<tr><td><input class="ch" type=submit value=수정>
<a href="memberManagement.do" class="re">취소</a></td></tr>
</table>
</form>
<table>
<tr>
