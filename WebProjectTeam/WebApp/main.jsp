...
<body>
    ...
    <section>
			...
			<!--1번 스와이퍼 시작-->
			    <div class="swiper-slide">
				    <div class="swiper-img">
					    <img src="img/hotel1.jpg" class="main-swiper-img">
				    </div>
			    ...
			    <div class="swiper-slide">
				    <div class="swiper-img">
					    <img src="img/lobby.jpg" class="main-swiper-img">
				    </div>
				    <div class="swiper-content">
					    <div class="swiper-content-text">
			    ...
			    <div class="swiper-slide">
				    <div class="swiper-img">
					    <img src="img/gym.jpg" class="main-swiper-img">
				    </div>
				    <div class="swiper-content">
					    <div class="swiper-content-text">
						    <p class="swiper-tag">KAJA Hotel 만의 다양한 서비스</p>
        ...
        <!-- 버튼 -->
        <div class="swiper-button-next"><img src="img/Next-btn.svg"></div>
		<div class="swiper-button-prev"><img src="img/Prev-btn.svg"></div>
        </div>
